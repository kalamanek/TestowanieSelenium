...
public final class DragAndDropDemo extends BasePage{
	...
	private final String childUrl = "drag-and-drop-demo.html";
...
//	}
	...
	public void dragElement(WebElement drag){
		try {
			String dragAndDropFn = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir") + "/src/test/java/testy/pageObject/dragAndDropDemo/native_js_drag_and_drop_helper.js")));
